...
public class MulActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOption.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent option = new Intent(MulActivity.this, OptionActivity.class);
        ...
        View.OnClickListener trainingButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent play = new Intent(MulActivity.this, TrainingActivity.class);
                startActivity(play);
            }
        };
        ...
        protected void onPreExecute() {
            ...
            if(dataMaxScore.getCount() == 0) {
                ...
                while (dataMaxScore.moveToNext()) {
                    maxScore = dataMaxScore.getInt(4);
                    break;
                }
            }
        }
    ...
    private class UpdateTable extends AsyncTask<Void, String, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            database.queryData("UPDATE MaxScore SET multiplication=" + maxScore + " WHERE Id = 1");
        }
