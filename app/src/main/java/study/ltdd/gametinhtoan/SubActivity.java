...
public class SubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOption.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent option = new Intent(SubActivity.this, OptionActivity.class);
        ...
        View.OnClickListener trainingButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent play = new Intent(SubActivity.this, TrainingActivity.class);
                startActivity(play);
            }
        };
        ...
        protected void onPreExecute() {
            ...
            if(dataMaxScore.getCount() == 0) {
                ...
                while (dataMaxScore.moveToNext()) {
                    maxScore = dataMaxScore.getInt(3);
                    break;
                }
            }
        }
    ...
    private class UpdateTable extends AsyncTask<Void, String, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            database.queryData("UPDATE MaxScore SET subtraction=" + maxScore + " WHERE Id = 1");
        }
