...
public class MulTableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener answerButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // answer is wrong
                if(!g.checkAnswer(answerSelected, 10 - progressBarTimer.getProgress()) || g.getTotalQuestions() == 21){
                    disEnableAns();
                    llBackground.setAlpha(0.05f);
                    showScoreWhenGameOver();
                    if(g.getTotalQuestions() < 20){
                        txtTitle.setText(R.string.oh_no);
                    }
                    ...
                    // answer is true
                    txtScore.setText(String.valueOf(g.getTotalQuestions()));
                    startGame();
                }
        ...
        btnOption.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent option = new Intent(MulTableActivity.this, OptionActivity.class);
        ...
        View.OnClickListener trainingButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent play = new Intent(MulTableActivity.this, TrainingActivity.class);
                startActivity(play);
            }
        };
    ...
    private void showScoreWhenGameOver(){
        txtScoreGameOver.setText(txtScore.getText() + "/20");
    }
    ...
    private class playAudioButton extends AsyncTask<Void, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            if(loaded){
                soundPool.play(mpButton, 1, 1, 1, 0, 1f);
            }
        }
        ...
        protected void onPreExecute() {
            ...
            if(dataMaxScore.getCount() == 0) {
                ...
                while (dataMaxScore.moveToNext()) {
                    maxScore = dataMaxScore.getInt(7);
                    break;
                }
            }
        }
    ...
    private class UpdateTable extends AsyncTask<Void, String, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            database.queryData("UPDATE MaxScore SET multiTable=" + maxScore + " WHERE Id = 1");
        }
